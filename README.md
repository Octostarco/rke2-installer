...
Octostar [RKE2](https://docs.rke2.io/) K8s cluster installer with Ansible, based on [our fork](https://github.com/Octostarco/ansible-role-rke2) of the [RKE2 Ansible Role](https://github.com/lablabs/ansible-role-rke2) by Labyrinth Labs.
